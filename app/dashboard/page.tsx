        ...
        <Tabs defaultValue='overview' className='space-y-4'>
          ...
          <TabsContent value='overview' className='space-y-6'>
            ...
            <div className='grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4'>
              ...
              />
              <MetricCard title='Subscriptions' value='+2,350' change='+180.1%' trend='up' icon={<Users className='h-5 w-5' />} description='from last month' />
              <MetricCard title='Sales' value='+12,234' change='+19%' trend='up' icon={<CreditCard className='h-5 w-5' />} description='from last month' />
              <MetricCard title='Active Now' value='+573' change='+201' trend='up' icon={<Activity className='h-5 w-5' />} description='since last hour' />
            </div>
