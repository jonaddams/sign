          ...
          <div className='mt-6 pt-4 border-t'>
            <div className='bg-zinc-100 dark:bg-zinc-800 rounded-md p-3 text-center'>
              ...
              <div className='mt-2 text-xs text-zinc-500 dark:text-zinc-400'>
                {documentTitle} | Expires: {state.document.expiresAt ? new Date(state.document.expiresAt).toLocaleDateString() : 'No expiration date'}
              </div>
            </div>
          </div>
        </div>
  ...
  return (
    <div className='space-y-6'>
      <div>
        ...
        <p className='text-muted-foreground mt-2 text-sm'>Customize the email that will be sent to all recipients when you send the document.</p>
      </div>
            ...
            <CardContent className='pt-6'>
              <div className='space-y-4'>
                <div className='space-y-2'>
                  ...
                  <Input id='email-subject' placeholder='Enter email subject' value={emailSubject} onChange={handleSubjectChange} />
                </div>
          ...
          <Card>
            <CardContent className='pt-6 flex items-start gap-3'>
              ...
              <div className='text-sm text-muted-foreground'>
                <strong>Tips:</strong> Personalize your message to increase response rates. Include your contact information in case recipients have questions.
                Be clear about what action you're requesting from recipients.
              </div>
            </CardContent>
          </Card>
        </TabsContent>
        ...
        <TabsContent value='preview' className='space-y-6 mt-4'>
          ...
          <Card>
            <CardContent className='pt-6 flex items-start gap-3'>
              <Info className='h-5 w-5 text-blue-500 shrink-0 mt-0.5' />
              <div className='text-sm text-muted-foreground'>
                This is how your email will appear to recipients. The actual email may vary slightly depending on the recipient's email client. All recipients
                will receive a similar email with a secure link to view and sign the document.
              </div>
            </CardContent>
          </Card>
        </TabsContent>
