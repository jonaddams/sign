        ...
        <div className='container mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='grid grid-cols-1 items-center gap-12 lg:grid-cols-2'>
            <div className='space-y-6'>
              <h1 className='text-4xl font-bold tracking-tight text-gray-900 md:text-5xl dark:text-white'>Sign documents securely from anywhere</h1>
              <p className='max-w-lg text-lg text-gray-600 dark:text-gray-300'>
                Streamline your document workflows with our secure, legally binding electronic signature solution. Save time, reduce costs, and improve
                efficiency.
              </p>
            ...
            {[
              {
                ...
                description: 'Our electronic signatures are legally binding and compliant with eSignature laws worldwide.',
              },
              {
              ...
              <div key={index} className='rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-zinc-700 dark:bg-zinc-800'>
                <div className='mb-4 flex h-12 w-12 items-center justify-center rounded-md bg-gray-100 dark:bg-zinc-700'>{feature.icon}</div>
      ...
      <section className='bg-blue-600 py-16 dark:bg-blue-900'>
        <div className='container mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='text-center'>
            ...
            <p className='mx-auto mb-8 max-w-2xl text-xl text-blue-100'>Join thousands of businesses that trust Sign for their document signing needs.</p>
            <Link href='/signup'>
